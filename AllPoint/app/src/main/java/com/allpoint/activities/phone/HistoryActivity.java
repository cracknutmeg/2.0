...
public class HistoryActivity extends FragmentActivity implements WebServiceListner {
    ...
    private void initGUIElements() {
        ...
        cardHistoryTitle = findViewById(R.id.tvcardhistoryTitle);
        curSavingIs = findViewById(R.id.curSaving);
    ...
    public void onResult(String result) {
        ...
        if (mRespForInvalidSession != null
                && mRespForInvalidSession.getSessionInvalidStatusCode().trim().equals(Constant.SESSION_ERROR_CODE)) {
            if (dialog != null) {
                dialog.dismiss();
            }
    ...
    private void displayExpandableList(ResponseTransaction mResult) {
        ...
        ExpandableListAdapter displayListAdapter = new ExpandableListAdapter(this, mResult);
